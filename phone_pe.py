...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"/Users/mansigour/Desktop/project1/pe.jpg"),width= 600)

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"/Users/mansigour/Desktop/project1/Pe2.jpg"), width=600)
    ...
    with col6:
        st.image(Image.open(r"/Users/mansigour/Desktop/project1/pe3.jpg"),width= 600)
